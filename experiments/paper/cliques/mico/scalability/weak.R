...
base1 <- min(data$runtime[data$db == "mico" & data$size == 4 & data$nworkers == 1])
base2 <- min(data$runtime[data$db == "mico" & data$size == 5 & data$nworkers == 1])
base3 <- min(data$runtime[data$db == "youtube" & data$size == 9 & data$nworkers == 1])
base4 <- min(data$runtime[data$db == "orkut" & data$size == 3 & data$nworkers == 1])

data$singlethread[data$db == "mico" & data$size == 4] <- base1 * 28
data$singlethread[data$db == "mico" & data$size == 5] <- base2 * 28
data$singlethread[data$db == "youtube" & data$size == 9] <- base3 * 28
data$singlethread[data$db == "orkut" & data$size == 3] <- base4 * 28
...
ggsave(file="cliques_scalability.pdf", family="serif", heigh=4, width=6)
ggsave(file="cliques_scalability.png", family="serif", heigh=4, width=6)
