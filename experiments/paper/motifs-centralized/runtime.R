...
datac <- summarySE(data, measurevar="runtime", groupvars=c("nthreads"))
...
ggplot(datac, aes(x=nthreads, y=runtime/1000, fill=factor(size))) + 
...
ggsave(file="motifs_mico_runtime.pdf", family="serif", heigh=4, width=6)
ggsave(file="motifs_mico_runtime.png", family="serif", heigh=4, width=6)
