...
import br.ufmg.cs.systems.fractal.pattern.{BasicPattern, Pattern, PatternExplorationPlanMCVC, PatternExplorationPlanMCVCOrdering, PatternExplorationPlanMCVCVgroups}
