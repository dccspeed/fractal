...
class ObjIteratorConsumer
[S <: Subgraph, K <: java.io.Serializable]
(val agg: ObjSubgraphAggregation[S, K], finishCallback: () => Unit)
   extends Iterator[K] {

   private var cursor: ObjCursor[K] = _
