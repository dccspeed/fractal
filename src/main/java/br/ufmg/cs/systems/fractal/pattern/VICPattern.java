...
import br.ufmg.cs.systems.fractal.util.collection.IntIntMapAddConsumer;
...
public class VICPattern extends BasicPattern {
    ...
    public void init(Configuration config) {
        super.init(config);
        addCandidatePatternEdgeConsumer = new AddCandidatePatternEdgeConsumer(config);
    }
    ...
    private class AddCandidatePatternEdgeConsumer implements IntConsumer {
        ...
        public AddCandidatePatternEdgeConsumer(Configuration configuration) {
