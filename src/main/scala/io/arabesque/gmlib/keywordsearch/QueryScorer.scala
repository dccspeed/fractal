package io.arabesque.gmlib.keywordsearch

import io.arabesque.embedding.EdgeInducedEmbedding
import io.arabesque.utils.collection.InvertedIndexMap
...
class QueryScorer(
  ...
  def score(e: EdgeInducedEmbedding): Double = {
    var total = 1.0
    var qi = 0
  ...
  // equation 2
  private def pqiG(qi: Int, e: EdgeInducedEmbedding): Double = {
    val n = e.getNumWords()
